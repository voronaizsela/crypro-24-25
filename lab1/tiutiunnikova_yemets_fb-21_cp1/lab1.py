...
ent_bi_s_per = calc_ent(fr_bi_s_per)
ent_bi_nos_per = calc_ent(fr_bi_nos_per)
ent_bi_s_noper = calc_ent(fr_bi_s_noper)
ent_bi_nos_noper = calc_ent(fr_bi_nos_noper)

max_ent_uni = np.log2(33)
max_ent_bi = np.log2(33**2)

r_uni_s = calc_r(ent_uni_s, max_ent_uni)
r_uni_nos = calc_r(ent_uni_nos, max_ent_uni)
r_bi_s_per = calc_r(ent_bi_s_per, max_ent_bi)
r_bi_nos_per = calc_r(ent_bi_nos_per, max_ent_bi)
r_bi_s_noper = calc_r(ent_bi_s_noper, max_ent_bi)
r_bi_nos_noper = calc_r(ent_bi_nos_noper, max_ent_bi)
